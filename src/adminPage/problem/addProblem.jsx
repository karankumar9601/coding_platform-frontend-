...
export default function AddProblem() {
    ...
    const submitProblem = async (data) => {
        try {
            const res = await axiosClient.post("/problem/create-problem", data);
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white p-4 md:p-8">
            <div className="max-w-5xl mx-auto bg-slate-900 p-6 rounded-2xl shadow-lg">
                <h2 className="text-2xl font-bold mb-6">Create Problem</h2>

                <form onSubmit={handleSubmit(submitProblem)} className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-green-500 text-black font-semibold py-3 rounded-xl">Create Problem</button>
                </form>
            </div>
        </div>
    );
